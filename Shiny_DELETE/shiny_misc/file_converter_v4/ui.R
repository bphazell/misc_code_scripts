shinyUI(fluidPage (
  ...
  #                 'Double Quote'),	
		...
		# 	'Double Quote'),
		 br(),
		 fileInput("file1", label="2. Upload File")
		...
		mainPanel(
			tabsetPanel(
				...
				tabPanel("Dedupe Data",
					HTML("<h4 style='color:MediumBlue'>Remove Duplicate Rows From the CSV</h4>"),
					...
					hr(),
					hr(),
					HTML("<h4 style='color:MediumBlue'>Or Remove Rows With Duplicate Values in a Single Column</h4>"),
				...
				tabPanel("URL Verifer (beta)",
					...
					br(),
					br(),
					#uiOutput("dupe_message"),
					downloadButton("download_broke_urls", "Download Broken URLs"),
					downloadButton("download_working_urls", "Download Working URLs"),
					br(),
					br(),
					h5("Rows with Broken URLs:"),
