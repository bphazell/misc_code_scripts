SELECT pn_list.pn AS pn, pn_list.org_name,
...
AND pn_list.pn != 'PN1098'
AND builder_jobs.user_id not in (
  SELECT seo_users.user_id
  FROM seo_users
)
GROUP BY pn_list.pn, pn_list.org_name
